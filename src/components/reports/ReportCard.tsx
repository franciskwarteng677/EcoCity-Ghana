...
export function ReportCard({ report, isSelected, onSelect }: ReportCardProps) {
  return (
    <button
      ...
      className={`w-full rounded-lg border bg-white p-5 text-left shadow-sm transition hover:border-civic-300 focus:outline-none focus:ring-2 focus:ring-civic-700 focus:ring-offset-2 ${
