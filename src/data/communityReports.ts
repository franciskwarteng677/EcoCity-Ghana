...
export type ReportVisibility = "under_review" | "public" | "hidden" | "rejected";
...
export const reportVisibilities: ReportVisibility[] = ["under_review", "public", "hidden", "rejected"];
...
export const reportVisibilityLabels: Record<ReportVisibility, string> = {
...
export function getReportVisibilityLabel(visibility: ReportVisibility) {
  return reportVisibilityLabels[visibility];
}
...
export function isReportVisibility(value: string): value is ReportVisibility {
  return reportVisibilities.includes(value as ReportVisibility);
}
...
export function normalizeReportVisibility(value?: string | null): ReportVisibility {
  if (value && isReportVisibility(value)) {
    return value;
  }
...
export function isPubliclyVisibleReport(report: Pick<CommunityReport, "publicVisibility" | "status">) {
  return report.publicVisibility !== "hidden" && report.publicVisibility !== "rejected" && report.status !== "rejected";
}
